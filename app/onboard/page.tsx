...
import { ArrowLeft, ArrowRight, CheckCircle2, Cpu, Lock } from 'lucide-react';
...
export default function OnboardPage() {
  ...
  return (
    <main className="min-h-screen bg-evoke-bg text-evoke-text-primary flex flex-col justify-between p-6 relative overflow-hidden transition-colors duration-300">
      {/* Gentle background gradient blur */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-[#7C6AFF]/5 dark:bg-[#7C6AFF]/10 rounded-full blur-[140px] pointer-events-none" />
      ...
      <header className="w-full max-w-4xl mx-auto flex items-center justify-between z-10 py-4">
        ...
        <div className="flex items-center gap-2">
          <span className="font-syne font-bold text-lg text-evoke-text-primary">Evoke</span>
          <span className="w-1.5 h-1.5 rounded-full bg-[#C5A880]" />
        </div>

        <div className="flex items-center gap-1.5 text-xs text-evoke-text-secondary font-mono">
      ...
      <div className="w-full max-w-2xl mx-auto my-auto z-10 py-8">
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            >
              <Card className="p-8 border-evoke-border bg-evoke-card" hoverEffect={false}>
                <div className="mb-6">
                  <span className="text-xs uppercase tracking-widest text-[#C5A880] font-semibold">
                    Step 1 of 4
                  </span>
                  <h2 className="font-syne text-2xl font-bold text-evoke-text-primary mt-1">
          ...
          {/* STEP 4: Optional Written Archives */}
          {step === 4 && (
            <motion.div
              key="step4"
              initial={{ opacity: 0, y: 15 }}
          ...
          {step === 5 && (
            ...
            >
              <Card className="p-10 border-[#4ECCA3]/40 bg-evoke-card shadow-[0_0_40px_rgba(78,204,163,0.1)] flex flex-col items-center" hoverEffect={false}>
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                ...
                <h2 className="font-syne text-3xl font-extrabold text-evoke-text-primary mb-2">
                  {formData.name || "Their"}'s memory vault is being built.
                </h2>
                <p className="text-sm text-evoke-text-secondary font-light max-w-md mb-8">
                  Synthesizing voice harmonics and structuring personality schema on AWS infrastructure.
                </p>

                {/* Progress Bar & Stage Notes */}
                <div className="w-full max-w-md bg-evoke-surface border border-evoke-border rounded-[10px] p-4 mb-8 text-left">
      ...
      {/* Footer minimal info */}
      <footer className="w-full max-w-4xl mx-auto text-center text-xs text-evoke-text-muted font-mono z-10 py-2">
