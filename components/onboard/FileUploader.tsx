  ...
  return (
    <div className="w-full flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className={`p-6 border-[#1E1E30] ${chatUploaded ? 'border-[#4ECCA3]/50 bg-[#0F0F1A]' : ''}`}>
          <div className="flex items-start gap-4 mb-4">
            ...
            <div>
              <h4 className="font-syne font-bold text-base text-[#F0F0F8]">WhatsApp Chat Export</h4>
          ...
          {chatUploaded ? (
            <div className="p-3 rounded-[10px] bg-[#14141F] border border-[#4ECCA3]/30 flex items-center justify-between">
              ...
              <button
                ...
                className="text-[11px] text-[#55556A] hover:text-[#F0F0F8]"
              >
                Remove
              </button>
            </div>
          ) : (
            <label className="flex items-center justify-center gap-2 p-4 border border-dashed border-[#1E1E30] hover:border-[#7C6AFF]/50 rounded-[10px] bg-[#0F0F1A] cursor-pointer text-xs font-medium text-[#9D8FFF]">
        ...
        <Card className={`p-6 border-[#1E1E30] ${lettersUploaded ? 'border-[#4ECCA3]/50 bg-[#0F0F1A]' : ''}`}>
          <div className="flex items-start gap-4 mb-4">
            <div className="w-12 h-12 rounded-[10px] bg-[#4ECCA3]/10 border border-[#4ECCA3]/30 flex items-center justify-center shrink-0">
              <BookOpen className="w-6 h-6 text-[#4ECCA3]" />
            </div>
            <div>
              <h4 className="font-syne font-bold text-base text-[#F0F0F8]">Letters & Journals</h4>
              <p className="text-xs text-[#9090A8] font-light mt-1">
          ...
          {lettersUploaded ? (
            ...
            <label className="flex items-center justify-center gap-2 p-4 border border-dashed border-[#1E1E30] hover:border-[#4ECCA3]/50 rounded-[10px] bg-[#0F0F1A] cursor-pointer text-xs font-medium text-[#4ECCA3]">
      ...
      {/* Actions Bar */}
      <div className="flex items-center justify-between pt-6 border-t border-[#1E1E30]">
        <Button
          variant="ghost"
          size="md"
